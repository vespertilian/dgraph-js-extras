...
function xUpsertTxn(upsertFn, data, dgraphClient, _dgraph) {
    if (_dgraph === void 0) { _dgraph = dgraph; }
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (Array.isArray(data)) {
                return [2 /*return*/, xUpsertArrayTxn(upsertFn, data, dgraphClient, _dgraph)];
            }
            else {
                return [2 /*return*/, xUpsertObjectTxn(upsertFn, data, dgraphClient, _dgraph)];
            }
            return [2 /*return*/];
        });
    });
}
exports.xUpsertTxn = xUpsertTxn;
function xUpsertArrayTxn(upsertFn, nodes, dgraphClient, _dgraph) {
    if (_dgraph === void 0) { _dgraph = dgraph; }
    return __awaiter(this, void 0, void 0, function () {
...
function xUpsertObjectTxn(upsertFn, node, dgraphClient, _dgraph) {
    if (_dgraph === void 0) { _dgraph = dgraph; }
    return __awaiter(this, void 0, void 0, function () {
