 ...
 * ```
 */
function xUpsertMapCommitTxn(queryFn, data, dgraphClient, _dgraph) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, upsert_1.xUpsertCommitTxn(queryFn, objects, dgraphClient, _dgraph)];
                case 1:
                    uids = _a.sent();
...
exports.xUpsertMapCommitTxn = xUpsertMapCommitTxn;
