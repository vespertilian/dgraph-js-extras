 ...
 * ```
 */
function xGetSchemaMapTxn(dgraphClient) {
    return __awaiter(this, void 0, void 0, function () {
        var query, res, schemaNodes, schemaMap;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    query = "\n                schema {\n                    type\n                    index\n                    reverse\n                    tokenizer\n                }\n        ";
                    return [4 /*yield*/, dgraphClient.newTxn().query(query)];
                case 1:
                    res = _a.sent();
                    schemaNodes = res.getSchemaList();
                    schemaMap = schemaNodes.reduce(function (accumulator, schemaNode) {
                        var predicate = schemaNode.getPredicate();
                    ...
                    return [2 /*return*/, schemaMap];
            }
        });
    });
}
exports.xGetSchemaMapTxn = xGetSchemaMapTxn;
