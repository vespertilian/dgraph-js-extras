 ...
 */
function xValidateNodePredicatesTxn(params, dgraphClient) {
    return __awaiter(this, void 0, void 0, function () {
        var txn;
        return __generator(this, function (_a) {
            txn = dgraphClient.newTxn();
            return [2 /*return*/, xValidateNodePredicates(params, txn)];
        });
    });
}
exports.xValidateNodePredicatesTxn = xValidateNodePredicatesTxn;
/**
 ...
 * ```
 */
function xValidateNodePredicates(params, txn) {
    return __awaiter(this, void 0, void 0, function () {
        var query, q;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    q = (_a.sent()).q;
                    return [2 /*return*/, (q.length === params.nodes.length)];
            }
        });
    });
}
exports.xValidateNodePredicates = xValidateNodePredicates;
