...
var __1 = require("..");
var drob_db_1 = require("./drob-db");
function XSetupForTestNow(config, _XCreateDgraphClient, _drop) {
    if (_XCreateDgraphClient === void 0) { _XCreateDgraphClient = create_dgraph_client_1.XCreateDgraphClient; }
    if (_drop === void 0) { _drop = drob_db_1.XDropDBNow; }
...
exports.XSetupForTestNow = XSetupForTestNow;
function XSetupWithSchemaDataNow(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, XSetupForTestNow({ debug: debugDgraphClient })];
                case 1:
                    _b = _c.sent(), dgraphClient = _b.dgraphClient, dgraphClientStub = _b.dgraphClientStub;
                    return [4 /*yield*/, __1.XSetSchemaNow(schema, dgraphClient)];
                case 2:
                    _c.sent();
                    result = null;
                    if (!data) return [3 /*break*/, 4];
                    return [4 /*yield*/, __1.XTrxSetJSNow(data, dgraphClient)];
                case 3:
                    result = _c.sent();
                    _c.label = 4;
                case 4: return [2 /*return*/, { dgraphClient: dgraphClient, dgraphClientStub: dgraphClientStub, result: result }];
            }
        });
    });
}
exports.XSetupWithSchemaDataNow = XSetupWithSchemaDataNow;
