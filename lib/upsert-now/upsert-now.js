    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (Array.isArray(data)) {
                return [2 /*return*/, XUpsertArrayNow(searchPredicates, data, dgraphClient, _dgraph)];
            }
            else {
                return [2 /*return*/, XUpsertObjectNow(searchPredicates, data, dgraphClient, _dgraph)];
            }
            return [2 /*return*/];
        });
    });
...
function XUpsertArrayNow(searchPredicates, nodes, dgraphClient, _dgraph) {
    if (_dgraph === void 0) { _dgraph = dgraph; }
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    currentNode = nodes[i];
                    return [4 /*yield*/, XUpsertObject(searchPredicates, currentNode, transaction)];
                case 3:
                    result = _a.sent();
                    results.push(result);
                    _a.label = 4;
...
function XUpsertObjectNow(searchPredicates, node, dgraphClient, _dgraph) {
    if (_dgraph === void 0) { _dgraph = dgraph; }
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 5, , 6]);
                    return [4 /*yield*/, XUpsertObject(searchPredicates, node, transaction)];
                case 3:
                    uid = _a.sent();
...
function XUpsertObject(searchPredicates, node, transaction) {
    return __awaiter(this, void 0, void 0, function () {
        var result, _a, query, searchValues, queryResult, _b, existingUid, others, error, updatedNode, mu, mu, muResult, uid, deeplyNestedObjectsDetected, error;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    mu = js_set_1.XSetJs(updatedNode);
